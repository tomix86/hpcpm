...
def start_request(*_):
    ...
    log.info(str.format('REQUEST STARTED: {} {} {}', request.real_ip, request.method, request.url))
...
def end_request(response_class):
    ...
    log.info(str.format('REQUEST FINISHED (took {} seconds): {} {} {}', request_processing_time, request.real_ip,
                        request.method,
                        request.url))
