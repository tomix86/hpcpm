...
__version__ = None
exec(open('hpcpm/management/version.py').read())
...
setup(name='hpc-power-management-management',
    version=__version__,
    description='HPC Power Management Management',
    author='dev.lel.lu',
    ...
    entry_points={
        'console_scripts': ['hpc-power-management-management=hpcpm.management.main:main']
    },
